...
# 단계별 테스트
poetry run pytest backend/tests/test_e2e_pdf_parsing.py -v
poetry run pytest backend/tests/test_e2e_structure_analysis.py -v
poetry run pytest backend/tests/test_e2e_extraction.py -v
```
...
- ✅ **API 응답만 검증**: DB 직접 조회 금지 (서버와 다른 DB 사용)
