"""
Ground Truth 데이터: 4차산업혁명 전문직의 미래.pdf
...
GROUND_TRUTH = {
    "book_title": "4차산업혁명전문직의미래",
    "pdf_file": "4차산업혁명 전문직의 미래.pdf",
    "original_pages": 427,  # 원본 PDF 페이지 수
    "total_pages": 854,  # 양면 분리 후 페이지 수 (원본 * 2)
    "main_start_page": 45,
    "main_end_page": 587,  # 종문 시작 페이지 - 1
    "chapters": [
        {
            "number": 1,
